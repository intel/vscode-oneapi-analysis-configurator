...
export const attributes: IAttributes = {
  ...
  private_copies: {
    ...
    signature: 'intel::private_copies(N)'
  },
  simple_dual_port: {
    ...
    signature: 'intel::simple_dual_port'
  },
  merge: {
    ...
    signature: 'intel::merge("key", "type")'
  },
  bank_bits: {
    ...
    signature: 'intel::bank_bits(b0, b1,..., bn)'
  }
};
