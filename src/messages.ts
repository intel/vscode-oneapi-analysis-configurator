export default {
  ...
  errCppSettings: 'Edit c++ properties failed. Initialize the oneAPI environment. Press Ctrl+Shift+P and execute "Intel oneAPI: Initialize environment variables".',
  errCppConfiguration: 'Configure c++ properties command failed.',
  errNoOneApiPath: 'ONE_API_PATH is not provided in your environment variables.',
