export default {
  ...
  updateOneApiRoot: 'ONEAPI ROOT was updated. It will update settings.json file from your .vscode folder and may update VTune & Advisor root paths',
  ...
  oneApiFromConfigurator: 'ONE API ROOT is taken from your Analysis Configurator extension\'s settings',
  oneApiFromProcEnv: 'ONE API ROOT is taken from your process environment variables',
  oneApiFromEnvConf: 'ONE API ROOT is taken from your Environment Configurator extension\'s settings',
